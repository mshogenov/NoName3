        ...
        while (true)
        {
            ...
            try
            {
                ...
                if (firstBreak != null)
                {
                    ...
                    Reference selectReference2 = SelectReference("Выберите вторую точку на трубе", new SelectionFilter());
                    ...
                    var midPipe = GetMidPipe(secondPipeToCut, break1, secondSplitPipe, break2, firstBreak, firstSplitPipe);
