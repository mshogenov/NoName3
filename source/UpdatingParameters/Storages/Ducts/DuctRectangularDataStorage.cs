...
public class DuctRectangularDataStorage(IDataLoader dataLoader) : DataStorageFormulas(dataLoader)
{
        ...
        var defaultFormulas = new CategoryFormulas
        {
            ...
            [
                ...
                new Formula
                {
                    ...
                    Significance = 
                        element?.FindParameter(BuiltInParameter.RBS_CALCULATED_SIZE)?.AsValueString() ?? "600x400"
                },
                new Formula
                {
